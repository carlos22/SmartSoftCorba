...
SmartPioneerBaseServer::SmartPioneerBaseServer()
{
	...
	ini.batteryEventServer.serviceName = "battery";
...
void SmartPioneerBaseServer::init(int argc, char *argv[])
{
	try
	{
		...
		batteryEventServer = new CHS::EventServer<
				CommBasicObjects::CommBatteryParameter,
				CommBasicObjects::CommBatteryEvent,
				CommBasicObjects::CommBatteryState>(component,
				ini.batteryEventServer.serviceName, batteryEventHandler);
...
void SmartPioneerBaseServer::loadParameter(int argc, char *argv[])
{
	...
	try
	{
		...
		parameter.getString("batteryEventServer", "serviceName",
				ini.batteryEventServer.serviceName);
