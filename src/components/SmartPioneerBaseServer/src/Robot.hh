...
public:
   ...
   */
  CommBasicObjects::CommBasePosition getBasePosition();
   ...
   */
  CommBasicObjects::CommBasePosition getBaseRawPosition();
...
private:
  ...
  //probabilistic
  bool updateCovMatrix( CommBasicObjects::CommBasePosition pos0,
						  CommBasicObjects::CommBasePosition &pos1 );
  ...
  CommBasicObjects::CommBasePosition robotPos, oldPos, rawPos;
