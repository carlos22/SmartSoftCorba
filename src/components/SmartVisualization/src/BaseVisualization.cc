...
void BaseVisualization::displayBase(const CommBasicObjects::CommBaseState& pos) {
	...
	CPose3D pose(p.get_x(1.0), p.get_y(1.0), p.get_z(1.0), p.get_azimuth(), p.get_elevation(), p.get_roll());
	CPose3D poseLabel1(p.get_x(1.0) - 0.3, p.get_y(1.0) + 0.3, p.get_z(1.0), p.get_azimuth(), p.get_elevation(), p.get_roll());
	CPose3D poseLabel2(p.get_x(1.0) - 0.4, p.get_y(1.0) + 0.3, p.get_z(1.0), p.get_azimuth(), p.get_elevation(), p.get_roll());
