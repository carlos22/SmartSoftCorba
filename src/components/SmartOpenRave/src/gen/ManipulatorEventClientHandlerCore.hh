...
#ifndef _MANIPULATOREVENTCLIENTHANDLERCORE_HH
#define _MANIPULATOREVENTCLIENTHANDLERCORE_HH
...
class ManipulatorEventClientHandlerCore: public CHS::EventHandler<
		Smart::CommManipulatorEventResult>
{
public:
	void handleEvent(const CHS::EventId id,
			const Smart::CommManipulatorEventResult &r) throw()
	{
	}
	;
};
