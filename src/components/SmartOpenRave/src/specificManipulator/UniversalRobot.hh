...
#ifndef _UniversalRobot_HH
#define _UNIVERSALROBOT_HH
 ...
 */
class UniversalRobot: public Manipulator {
...
public:
	...
	void getActivDofsWithGripper(std::vector<int>& dofs);

	bool removeDummyJointAngles(std::vector<double>& angles);

	void getOffsetRealManipulatortoOpenRaveManipulator(double& x, double& y, double& z);
