...
void ParameterServerHandler::handleSend(const Smart::CommManipulationPlannerParameter &r) throw() {
	try {
		OPENRAVE->setParameter(r);
	} catch (openrave_exception& e) {
		ErrorHandler::handleMessage(e.message(), Smart::PARAMETER_FAIL, ErrorHandler::ERROR);
