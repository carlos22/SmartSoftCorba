...
#ifndef _MANIPULATOREVENTCLIENTHANDLER_HH
#define _MANIPULATOREVENTCLIENTHANDLER_HH
...
#include "gen/ManipulatorEventClientHandlerCore.hh"

class ManipulatorEventClientHandler: public ManipulatorEventClientHandlerCore {
	void handleEvent(const CHS::EventId id, const CommManipulatorObjects::CommManipulatorEventResult &r) throw();
};
