...
#ifndef _EVENTSERVERHANDLER_HH
#define _EVENTSERVERHANDLER_HH
...
#include "gen/EventServerHandlerCore.hh"

class EventServerHandler: public EventServerHandlerCore {
	bool testEvent(CommManipulationPlannerObjects::CommManipulationPlannerEventParameter &p, CommManipulationPlannerObjects::CommManipulationPlannerEventResult &r,
