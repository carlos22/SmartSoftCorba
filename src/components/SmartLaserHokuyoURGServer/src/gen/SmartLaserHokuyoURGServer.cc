...
{
	std::cout << "constructor SmartLaserHokuyoURGServer\n";
...
void SmartLaserHokuyoURGServer::init(int argc, char *argv[])
{
	try
	{
		component = new CHS::SmartComponent("SmartLaserHokuyoURGServer", argc,
				argv);
		loadParameter(argc, argv);

		// create ports
		laserPushTimedServer = new CHS::PushTimedServer<
				CommExternalObjects::CommMobileLaserScan>(component,
		...
		manipulatorTimedClient = new CHS::PushTimedClient<CommManipulatorObjects::CommMobileManipulatorState>(component);
		baseTimedClient = new CHS::PushTimedClient<CommExternalObjects::CommBaseState>(component);
		laserQueryServer = new CHS::QueryServer<CommExternalObjects::CommVoid,
				CommExternalObjects::CommMobileLaserScan>(component,
