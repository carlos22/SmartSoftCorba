...
public:
	...
	// ports
	CHS::PushTimedServer<CommExternalObjects::CommMobileLaserScan>
			*laserPushTimedServer;
	CHS::PushNewestServer<CommExternalObjects::CommMobileLaserScan>
			*laserPushNewestServer;
	CHS::PushTimedClient<CommManipulatorObjects::CommMobileManipulatorState>
			*manipulatorTimedClient;
	CHS::PushTimedClient<CommExternalObjects::CommBaseState> *baseTimedClient;
	CHS::QueryServer<CommExternalObjects::CommVoid,
			CommExternalObjects::CommMobileLaserScan> *laserQueryServer;
