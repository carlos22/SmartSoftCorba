...
class LaserQueryHandlerCore: public CHS::QueryServerHandler<
		CommExternalObjects::CommVoid, CommExternalObjects::CommMobileLaserScan>
{
public:
	void handleQuery(CHS::QueryServer<CommExternalObjects::CommVoid,
			CommExternalObjects::CommMobileLaserScan> & server,
			const CHS::QueryId id,
			const CommExternalObjects::CommVoid & request) throw()
	{
	}
	;
};
