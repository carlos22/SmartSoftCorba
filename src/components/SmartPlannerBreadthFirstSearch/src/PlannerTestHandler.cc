...
bool PlannerTestHandler::testEvent(CommNavigationObjects::CommPlannerEventParameter &p,
		CommNavigationObjects::CommPlannerEventResult &r, const CommNavigationObjects::PlannerEventState &s) throw()
{
	bool result = false;
