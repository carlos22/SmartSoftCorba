	...
	ImageTaskCondMutex(ImageTaskMutex)
{
	...
	ini.component.initialize_camera = true;
	ini.component.processing_parameter = "";
	ini.component.processing_plugin
			= "src/components/SmartPMDServer/src/pmd/plugins/camcubeproc.L32.ppp";
	ini.component.source_parameter = "";
	ini.component.source_plugin
			= "src/components/SmartPMDServer/src/pmd/plugins/camcube.L32.pap";
...
void SmartPMDServer::loadParameter(int argc, char *argv[])
{
	...
	try
	{
		...
		parameter.getTruthValue("component", "initialize_camera",
				ini.component.initialize_camera);
		parameter.getString("component", "processing_parameter",
				ini.component.processing_parameter);
		parameter.getString("component", "processing_plugin",
				ini.component.processing_plugin);
		parameter.getString("component", "source_parameter",
				ini.component.source_parameter);
		parameter.getString("component", "source_plugin",
				ini.component.source_plugin);
