		...
		const CommBasicObjects::CommBasePositionUpdate &r) throw()
{
	...
	{
		std::cout << "Incoming position update " << r << " received!!!" << std::endl;
	}

	COMP->GlobalLock.acquire();
		// calculate correction difference from position update and store it in the pos_diff
		CommDataTranslator::convert(r, COMP->pos_diff);
