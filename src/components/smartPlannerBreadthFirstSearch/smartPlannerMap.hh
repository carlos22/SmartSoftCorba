...
#include "smartPlannerFifo.h"
#include "smartPlannerGoalFifo.h"
#include "smartPlannerTypes.h"
#include "smartPlannerMapTypes.h"
#include "smartPlannerEvent.hh"
...
class PlannerMapClass : public CommGridMap
{
protected:
  //PlannerMapType data;
...
*/
  ...
  int setMapperMap(Smart::CommGridMap&);
