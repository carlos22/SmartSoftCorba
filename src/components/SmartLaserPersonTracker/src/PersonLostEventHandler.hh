...
#ifndef _PERSONLOSTEVENTHANDLER_HH
#define _PERSONLOSTEVENTHANDLER_HH
...
#include "gen/PersonLostEventHandlerCore.hh"

class PersonLostEventHandler: public PersonLostEventHandlerCore
{
