...
#ifndef _SMARTLASERXFIG_HH
#define _SMARTLASERXFIG_HH

#include <stdio.h>
#include <stdlib.h>
#include <string>

#include "smartLaserFigObject.h"
...
public:
  ...
  virtual ~SmartLaserXfigClass();
  // Implicitly destroy the SmartLaserXfigClass.
