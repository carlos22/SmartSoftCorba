...
#ifndef _HANDLEGETNEWPOINT_HH
#define _HANDLEGETNEWPOINT_HH
...
#include "gen/HandleGetNewPointCore.hh"

class HandleGetNewPoint: public HandleGetNewPointCore
{
	void
			handleQuery(CHS::QueryServer<Smart::CommMoMaPose,
