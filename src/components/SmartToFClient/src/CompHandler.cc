...
void CompHandler::onStartup()
{
	...
	std::cout << "connecting to: " << COMP->ini.imageQueryClient.serverName
			<< "; " << COMP->ini.imageQueryClient.serviceName << std::endl;
	status = COMP->imageQueryClient->connect(
			COMP->ini.imageQueryClient.serverName,
			COMP->ini.imageQueryClient.serviceName);
