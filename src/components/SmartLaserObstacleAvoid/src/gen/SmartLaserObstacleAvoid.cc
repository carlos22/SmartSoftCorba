...
#include "SmartLaserObstacleAvoid.hh"

// constructor
SmartLaserObstacleAvoid::SmartLaserObstacleAvoid()
{
	std::cout << "constructor of SmartLaserObstacleAvoid\n";

	ini.component.name = "SmartLaserObstacleAvoid";

	ini.laserClient.serverName = "SmartLaserLMS200Server";
	ini.laserClient.serviceName = "scan";
	ini.navigationVelocitySendClient.serverName = "SmartPioneerBaseServer";
	ini.navigationVelocitySendClient.serviceName = "navigationvelocity";
}

void SmartLaserObstacleAvoid::init(int argc, char *argv[])
{
	try
	{
		...
		navigationVelocitySendClient->add(wiringSlave,
...
// run the component
void SmartLaserObstacleAvoid::run()
{
...
void SmartLaserObstacleAvoid::loadParameter(int argc, char *argv[])
{
	/* 
	...
	try
	{
		...
		{
			std::cout << "load SmartLaserObstacleAvoid.ini parameter file\n";
			parameter.addFile("SmartLaserObstacleAvoid.ini");
		}
		...
		parameter.getString("navigationVelocitySendClient", "serverName",
				ini.navigationVelocitySendClient.serverName);
		parameter.getString("navigationVelocitySendClient", "serviceName",
				ini.navigationVelocitySendClient.serviceName);
