...
SmartRobotConsole::SmartRobotConsole()
{
	...
	ini.followMeParameterClient.serverName = "SmartLaserPersonTracker";
	ini.followMeParameterClient.serviceName = "param";
	...
	ini.personDetectionParameterClient.serverName
			= "SmartKinectPersonDetection";
	ini.personDetectionParameterClient.serviceName = "param";
	...
	ini.schunkGripperParameterClient.serverName = "SmartSchunkGripperServer";
	ini.schunkGripperParameterClient.serviceName = "param";
	...
	ini.speechStateClient.serviceName = "state";
}
...
void SmartRobotConsole::init(int argc, char *argv[])
{
	try
	{
		...
		followMeParameterClient = new CHS::SendClient<
		...
		personDetectionParameterClient = new CHS::SendClient<
				CommPersonDetectionObjects::CommPersonDetectionParameter>(
				component);
		...
		schunkGripperParameterClient = new CHS::SendClient<
				CommManipulatorObjects::CommGripperParam>(component);
		...
		amclParameterClient->add(wiringSlave, "amclParameterClient");
		amclStateClient->add(wiringSlave, "amclStateClient");
		baseParameterClient->add(wiringSlave, "baseParameterClient");
		cdlGoalEventClient->add(wiringSlave, "cdlGoalEventClient");
		cdlParameterClient->add(wiringSlave, "cdlParameterClient");
		cdlStateClient->add(wiringSlave, "cdlStateClient");
		followMeParameterClient->add(wiringSlave, "followMeParameterClient");
		forkliftParameterClient->add(wiringSlave, "forkliftParameterClient");
		gmappingParameterClient->add(wiringSlave, "gmappingParameterClient");
		mapperParameterClient->add(wiringSlave, "mapperParameterClient");
		mapperStateClient->add(wiringSlave, "mapperStateClient");
		personDetectionParameterClient->add(wiringSlave,
				"personDetectionParameterClient");
		plannerEventClient->add(wiringSlave, "plannerEventClient");
		plannerParameterClient->add(wiringSlave, "plannerParameterClient");
		plannerStateClient->add(wiringSlave, "plannerStateClient");
		ptuQueryClient->add(wiringSlave, "ptuQueryClient");
		ptuStateClient->add(wiringSlave, "ptuStateClient");
		schunkGripperParameterClient->add(wiringSlave,
				"schunkGripperParameterClient");
		speechParameterClient->add(wiringSlave, "speechParameterClient");
		speechSendClient->add(wiringSlave, "speechSendClient");
		speechStateClient->add(wiringSlave, "speechStateClient");
...
void SmartRobotConsole::loadParameter(int argc, char *argv[])
{
	...
	try
	{
		...
		parameter.getString("followMeParameterClient", "serverName",
				ini.followMeParameterClient.serverName);
		parameter.getString("followMeParameterClient", "serviceName",
				ini.followMeParameterClient.serviceName);
		...
		parameter.getString("personDetectionParameterClient", "serverName",
				ini.personDetectionParameterClient.serverName);
		parameter.getString("personDetectionParameterClient", "serviceName",
				ini.personDetectionParameterClient.serviceName);
		...
		parameter.getString("schunkGripperParameterClient", "serverName",
				ini.schunkGripperParameterClient.serverName);
		parameter.getString("schunkGripperParameterClient", "serviceName",
				ini.schunkGripperParameterClient.serviceName);
