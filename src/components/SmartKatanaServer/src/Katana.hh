...
public:
	 ...
	 */
	void performTrajectory(const Smart::CommManipulatorTrajectory &trajectory);
	 ...
	 */
	void getCurrentState(Smart::CommManipulatorState &state);
	 ...
	 */
	void setParameter(const Smart::CommManipulatorParameter &param);
	 ...
	 */
	void performLaserScan(const Smart::CommManipulatorRequestScan3d &request,
	 ...
	 */
	void get3dPointCloud(const Smart::CommManipulatorId &request,
...
private:
	 ...
	 */
	void
			moveManipulator(const Smart::CommManipulatorTrajectory &trajectory,
	 ...
	 */
	void handleException(const std::string& message,
			Smart::ManipulatorEvent event);

private:
	/**
	 * Helper class for locking the access to the Katana
	 */
	class Guard {
	private:
	...
	public:
		Guard(CHS::SmartMutex& mutex, bool doAcquire = true) :
