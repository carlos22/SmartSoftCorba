...
#ifndef FAW_DRAWING_PRINT_ACTION_HH
#define FAW_DRAWING_PRINT_ACTION_HH
...
/**
  Print the scene graph to an output stream.
  To be used for debugging purposes.
 */
class DrawingPrintAction: public DrawingAction
{
public:
  DrawingPrintAction(std::ostream &os);
