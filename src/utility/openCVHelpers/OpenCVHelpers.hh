...
public:
	 ...
	 *
	 */
	static IplImage* copyFloatToIplImage( float* const floatImage, const int height, const int width) {
	    // copy ToF Data into a float IplImage (IPL_DEPTH_32F)
	    CvMat dataMatrix;
	    cvInitMatHeader(&dataMatrix, height, width, CV_32FC1, floatImage);
