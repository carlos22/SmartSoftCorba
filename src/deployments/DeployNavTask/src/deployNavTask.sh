...
xterm -e ./smartCdlServer -filename=SmartCdlServer.ini -ORBInitRef NameService=corbaloc:iiop:0.0.0.0:12345/NameService &
...
xterm -e ./smartMapperGridMap -filename=SmartMapperGridMap.ini -ORBInitRef NameService=corbaloc:iiop:0.0.0.0:12345/NameService &
...
xterm -e ./smartPlannerBreadthFirstSearch -filename=SmartPlannerBreadthFirstSearch.ini -ORBInitRef NameService=corbaloc:iiop:0.0.0.0:12345/NameService &
xterm -e ./smartPlayerStageSimulator -filename=SmartPlayerStageSimulator.ini -ORBInitRef NameService=corbaloc:iiop:0.0.0.0:12345/NameService &
xterm -e ./smartRobotConsole -filename=SmartRobotConsole.ini -ORBInitRef NameService=corbaloc:iiop:0.0.0.0:12345/NameService &
