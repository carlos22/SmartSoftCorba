...
void CommManipulatorTrajectory::set(const CORBA::Any &a) {
	CommManipulatorObjectsIDL::CommManipulatorTrajectory *tmp_cmd;
	if (a >>= tmp_cmd) {
...
void CommManipulatorTrajectory::print(std::ostream &os) const {
	...
	os << "gripperAction=" << idl_CommManipulatorTrajectory.gripper << "\n";
	os << "validValues=" << idl_CommManipulatorTrajectory.flag;
