...
public:
	...
	inline const CommManipulatorObjectsIDL::CommManipulatorParameter &get() const {
		return idl_CommManipulatorParameter;
	}

	inline void set(const CommManipulatorObjectsIDL::CommManipulatorParameter &obj) {
		idl_CommManipulatorParameter = obj;
	}
	...
	inline int set(std::string &inString) {
		...
		// --------------------
			...
			idl_CommManipulatorParameter.mode
					= ManipulatorParameterMode(ManipulatorParameterMode::CALIBRATE).get_value_idl();
		}
		// --------------------
		// set the calibrate axis
		// --------------------
		else if (strcasecmp(param, "CALIBRATEAXIS") == 0) {
			idl_CommManipulatorParameter.mode
					= ManipulatorParameterMode(ManipulatorParameterMode::CALIBRATE_AXIS).get_value_idl();
