...
#include <enumManipulatorGripperAction.hh>
#include <enumManipulatorTrajectoryFlag.hh>
...
public:
	...
	inline void set_trajectory_size(uint32_t size) {
		if (idl_CommManipulatorTrajectory.gripper == SmartIDL::LITERAL_ANGLE)
			idl_CommManipulatorTrajectory.gripper_angles.length(size);

		if (idl_CommManipulatorTrajectory.flag == SmartIDL::LITERAL_JOINT_ANGLES)
			idl_CommManipulatorTrajectory.joint_angles.length(size);

		if (idl_CommManipulatorTrajectory.flag == SmartIDL::LITERAL_POSES)
	...
	inline void set_gripper_action(ManipulatorGripperAction action) {
		idl_CommManipulatorTrajectory.gripper = (SmartIDL::ENUM_ManipulatorGripperAction) action;
	}
	...
	inline ManipulatorGripperAction get_gripper_action() const {
		return (ManipulatorGripperAction) idl_CommManipulatorTrajectory.gripper;
	}
	...
	inline void set_valid_values(ManipulatorTrajectoryFlag flag) {
		idl_CommManipulatorTrajectory.flag = (SmartIDL::ENUM_ManipulatorTrajectoryFlag) flag;
	}
	...
	inline ManipulatorTrajectoryFlag get_valid_values() const {
		return (ManipulatorTrajectoryFlag) idl_CommManipulatorTrajectory.flag;
	}
