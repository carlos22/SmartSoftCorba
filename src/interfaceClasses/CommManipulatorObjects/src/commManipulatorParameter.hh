...
public:
	/**
	 * Enum which specify which parameter is set.
	...
	enum KatanaTagType
	{
		TRAJECTORY = SmartIDL::TRAJECTORY,
		SINGLE_POSE = SmartIDL::SINGLE_POSE,
		SET_ALL_JOINT_VELOCITY_LIMITS = SmartIDL::SET_ALL_JOINT_VELOCITY_LIMITS,
		SET_GRIPPER_VELOCITY_LIMIT = SmartIDL::SET_GRIPPER_VELOCITY_LIMIT
	};
	...
	inline int set(std::string &inString)
	{
		...
		if (strcasecmp(param, "ALLJOINTVELLIMITS") == 0)
		{
			idl_CommManipulatorParameter.mode
					= (SmartIDL::enum_mode) SET_ALL_JOINT_VELOCITY_LIMITS;
		...
		{
			idl_CommManipulatorParameter.mode
					= (SmartIDL::enum_mode) SET_GRIPPER_VELOCITY_LIMIT;
		...
		{
			idl_CommManipulatorParameter.mode
					= (SmartIDL::enum_mode) SINGLE_POSE;
		}
		// --------------------
		// got garbage
		// --------------------
	 ...
	 */
	inline void get(KatanaTagType &tag, int32_t &value01) const
	{
		tag = (KatanaTagType) idl_CommManipulatorParameter.mode;
