...
#ifndef SMART_COMM_LASER_SCAN_HH
#define SMART_COMM_LASER_SCAN_HH
...
{
protected:
  SmartIDL::LaserScan _scan;

public:

  CommLaserScan();
  CommLaserScan(const SmartIDL::LaserScan &scan);
  virtual ~CommLaserScan();

  void get(CORBA::Any &a) const;
  void set(const CORBA::Any &a);
  static inline std::string identifier() { return "Smart::CommLaserScan"; };

  /// \internal
  inline const SmartIDL::LaserScan &get_idl() const { return _scan; }
  /// \internal
  inline void set_idl(const SmartIDL::LaserScan &scan) { _scan = scan; }
   ...
   */
  inline double get_scan_start_angle() const { return _hd2r(_scan.start_angle); }
  ...
  { 
    return _hd2r(_norm_angle(int(_scan.start_angle) + _scan.scan_points[i].index*int(_scan.resolution))); 
  }
