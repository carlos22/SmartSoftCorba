...
public:
	...
	inline const CommObjectRecognitionObjectsIDL::CommObjectRecognitionObjectProperties &get() const
	{
	 ...
	 * (ok((id ?id)(type ?type)(color ?color)(pose ?x ?y ?z ?azimuth ?elevation ?roll)(dimension ?x ?y ?z)))
	 */
	...
	inline void set_color(Color color) {
		idl_CommObjectRecognitionObjectProperties.object_color = color.get_value_idl();
	}
	...
	inline Color get_color() const {
		return (Color) idl_CommObjectRecognitionObjectProperties.object_color;
	}
	...
	inline void set_pose(const CommBasicObjects::CommPose3d& pose) {
		idl_CommObjectRecognitionObjectProperties.pose = pose.get_idl();
	}
