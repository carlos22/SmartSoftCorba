...
#ifndef _COMM_COMMOBJECTRECOGNITIONOBJECTS_SIMPLEOBJECTEVENTSTATE_HH
#define _COMM_COMMOBJECTRECOGNITIONOBJECTS_SIMPLEOBJECTEVENTSTATE_HH
...
class SimpleObjectEventState
{

protected:
	SimpleObjectState newState;
	long x;
	long y;
