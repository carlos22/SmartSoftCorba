...
public:
	enum literal
	{
		...
		CLUSTERING_OFF = CommObjectRecognitionObjectsIDL::LITERAL_CLUSTERING_OFF,

		CLUSTERING_ON = CommObjectRecognitionObjectsIDL::LITERAL_CLUSTERING_ON,
	...
	std::string get_string() const
	{
		...
		case CLUSTERING_OFF:
			return "ObjectRecognitionBehavior::CLUSTERING_OFF";
			break;

		case CLUSTERING_ON:
			return "ObjectRecognitionBehavior::CLUSTERING_ON";
			break;
