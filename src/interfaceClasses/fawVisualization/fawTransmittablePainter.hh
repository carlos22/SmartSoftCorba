...
#ifndef FAW_TRANSMITTABLE_PAINTER_HH
#define FAW_TRANSMITTABLE_PAINTER_HH
...
typedef GenericTransmittable<DrawingStoreReplayPainter,true> TransmittablePainter;
