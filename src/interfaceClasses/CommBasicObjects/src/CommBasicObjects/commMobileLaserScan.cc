...
{
	CommBasicObjectsIDL::CommMobileLaserScan *tmp_cmd;
	if (a >>= tmp_cmd)
	{
		_scan = *tmp_cmd;
	}
...
{
  CommBasicObjectsIDL::CommLaserScan tmp_scan = _scan.laser_scan_pose.laser_scan;
...
{
  static const Smart::KnuthMorrisPratt kmp_begin("<mobile_laser_scan>");

  static const Smart::KnuthMorrisPratt kmp_end("</mobile_laser_scan>");
