...
#ifndef _COMM_COMMBASICOBJECTS_COMMMOBILELASERSCAN_HH
#define _COMM_COMMBASICOBJECTS_COMMMOBILELASERSCAN_HH
...
#include <CommBasicObjects/gen/structLaserScan6DPoseC.hh>
...
#include "CommBasicObjects/gen/smartCommMobileLaserScanC.hh"
...
protected:
	...
	CommBasicObjectsIDL::CommMobileLaserScan _scan;
...
public:
	...
	CommMobileLaserScan(const CommBasicObjectsIDL::CommMobileLaserScan &obj) :
		_scan(obj)
	{
	}
	...
	// user interfaces
	  ...
	  */
	   ...
	   */
	  inline double get_scan_start_angle() const { return _d2r(_scan.laser_scan_pose.laser_scan.start_angle); }
	   ...
	   */
	  inline double get_scan_resolution() const { return _d2r(_scan.laser_scan_pose.laser_scan.resolution); }
	  ...
	  {
	    return _d2r(_norm_angle(_scan.laser_scan_pose.laser_scan.start_angle + _scan.laser_scan_pose.laser_scan.scan_points[i].index * _scan.laser_scan_pose.laser_scan.resolution));
	  }
