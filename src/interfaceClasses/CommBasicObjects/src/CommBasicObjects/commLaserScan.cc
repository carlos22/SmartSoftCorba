...
{
	CommBasicObjectsIDL::CommLaserScan *tmp_cmd;
	if (a >>= tmp_cmd)
	{
		_scan = *tmp_cmd;
	}
...
{
  static const Smart::KnuthMorrisPratt kmp_begin("<laser_scan>");
  ...
  static const Smart::KnuthMorrisPratt kmp_points("<points n=\"");
  static const Smart::KnuthMorrisPratt kmp_index("<point index=\"");
  static const Smart::KnuthMorrisPratt kmp_distance("distance=\"");
  static const Smart::KnuthMorrisPratt kmp_intensity("intensity=\"");
  static const Smart::KnuthMorrisPratt kmp_end("</laser_scan>");
