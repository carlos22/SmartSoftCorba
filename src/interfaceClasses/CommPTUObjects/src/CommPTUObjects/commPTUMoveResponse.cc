...
#include "commPTUMoveResponse.hh"

using namespace CommPTUObjects;

void CommPTUMoveResponse::get(CORBA::Any &a) const
{
	a <<= idl_CommPTUMoveResponse;
}

void CommPTUMoveResponse::set(const CORBA::Any &a)
{
	CommPTUObjectsIDL::CommPTUMoveResponse *tmp_cmd;
	if (a >>= tmp_cmd)
	{
		idl_CommPTUMoveResponse = *tmp_cmd;
	}
}
