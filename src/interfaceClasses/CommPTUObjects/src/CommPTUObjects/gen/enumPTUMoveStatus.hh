...
public:
	enum literal
	{
		...
		GOAL_NOT_REACHED = CommPTUObjectsIDL::LITERAL_GOAL_NOT_REACHED,

		GOAL_REACHED = CommPTUObjectsIDL::LITERAL_GOAL_REACHED,
		...
		UNKNOWN = CommPTUObjectsIDL::LITERAL_UNKNOWN
	};
