...
#include "gen/SampleEnumerationSendServer.hh"

#include <iostream>

void EnumSendHandler::handleSend(
		const CommSampleObjects::CommSampleEnumeration &r) throw()
{
	// change this code to your needs !!!
	std::cout << "Received Enumeration: ";
	if(r.get_value() == CommSampleObjects::SampleEnumeration::DEG) {
		std::cout << " DEG\n";
	} else if (r.get_value() == CommSampleObjects::SampleEnumeration::RAD) {
		std::cout << " RAD\n";
	}
