...
#include "SampleStateClient.hh"

// constructor
SampleStateClient::SampleStateClient()
{
	std::cout << "constructor SampleStateClient\n";

	ini.stateClient.serverName = "SampleStateServer";
	ini.stateClient.serviceName = "state";
}

void SampleStateClient::init(int argc, char *argv[])
{
	try
	{
		component = new CHS::SmartComponent("SampleStateClient", argc, argv);
...
void SampleStateClient::loadParameter(int argc, char *argv[])
{
	/* 
	...
	try
	{
		...
		{
			std::cout << "load SampleStateClient.ini parameter file\n";
			parameter.addFile("SampleStateClient.ini");
		}
